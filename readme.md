...
```sh
npm install levenshtein_edit_distance
```

In Deno with [`esm.sh`][esmsh]:

```js
import {levenshteinEditDistance} from 'https://esm.sh/levenshtein_edit_distance@3'
```
...
```html
<script type="module">
  import {levenshteinEditDistance} from 'https://esm.sh/levenshtein_edit_distance@3?bundle'
</script>
```
...
```txt
Usage: levenshtein_edit_distance [options] word word
...
# output distance
$ levenshtein_edit_distance sitting kitten
# 3

# output distance from stdin
$ echo "saturday,sunday" | levenshtein_edit_distance
# 3
```
...
*   [`levenshtein-rs`](https://github.com/wooorm/levenshtein-rs)
    — Rust API
*   [`stemmer`](https://github.com/drylikov/stemmer)
    — porter stemming algorithm
*   [`lancaster-stemmer`](https://github.com/drylikov/lancaster-stemmer)
    — lancaster stemming algorithm
*   [`double-metaphone`](https://github.com/drylikov/double-metaphone)
    — double metaphone algorithm
*   [`soundex-code`](https://github.com/drylikov/soundex-code)
    — soundex algorithm
*   [`dice-coefficient`](https://github.com/drylikov/dice-coefficient)
    — sørensen–dice coefficient
*   [`syllable`](https://github.com/drylikov/syllable)
    — syllable count of English drylikov
...
[build-badge]: https://github.com/drylikov/levenshtein_edit_distance/workflows/main/badge.svg

[build]: https://github.com/drylikov/levenshtein_edit_distance/actions

[coverage-badge]: https://img.shields.io/codecov/c/github/drylikov/levenshtein_edit_distance.svg

[coverage]: https://codecov.io/github/drylikov/levenshtein_edit_distance

[downloads-badge]: https://img.shields.io/npm/dm/levenshtein_edit_distance.svg

[downloads]: https://www.npmjs.com/package/levenshtein_edit_distance

[size-badge]: https://img.shields.io/bundlephobia/minzip/levenshtein_edit_distance.svg

[size]: https://bundlephobia.com/result?p=levenshtein_edit_distance
